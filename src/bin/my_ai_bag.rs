...
fn tools_panel(
    report: RwSignal<my_ai_bag::ScanReport>,
...
fn tool_row(tool: my_ai_bag::ToolScan, selected: RwSignal<BTreeSet<String>>) -> impl IntoView {
...
fn scan_from_inputs(search_root: &str, project_root: &str) -> my_ai_bag::ScanReport {
    ...
    scan_tools(&ScanOptions {
        home_dir,
        project_root,
        catalog: my_ai_bag::builtin_tools(),
    })
}

fn default_selected(report: &my_ai_bag::ScanReport) -> BTreeSet<String> {
    report
        .tools
        .iter()
